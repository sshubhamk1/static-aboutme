...
/* harmony export */   "v": function() { return /* binding */ getTagColor; }
/* harmony export */ });
...
const theme = (0,_chakra_ui_react__WEBPACK_IMPORTED_MODULE_0__.extendTheme)({
  ...
  styles: {
    global: props => ({
      body: {
        color: (0,_chakra_ui_theme_tools__WEBPACK_IMPORTED_MODULE_1__.mode)("gray.700", "whiteAlpha.900")(props),
        bg: (0,_chakra_ui_theme_tools__WEBPACK_IMPORTED_MODULE_1__.mode)("gray.50", "gray.900")(props),
        fontSize: "1.2em",
        ".deleted": {
      ...
      a: {
        color: (0,_chakra_ui_theme_tools__WEBPACK_IMPORTED_MODULE_1__.mode)("blue.500", "blue.200")(props),
        transition: "color 0.15s",
        transitionTimingFunction: "ease-out",
        fontWeight: "500",
        _hover: {
          color: (0,_chakra_ui_theme_tools__WEBPACK_IMPORTED_MODULE_1__.mode)("blue.600", "blue.300")(props)
        }
      }
    })
  },
